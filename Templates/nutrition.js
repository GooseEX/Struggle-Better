...
function setup() {
  ...
  $("#nutrition_tip2").click(toggleWhenClicked);
  $("#nutrition_tip3").click(toggleWhenClicked);
  $("#nutrition_tip4").click(toggleWhenClicked);
  $("#nutrition_tip5").click(toggleWhenClicked);
  $("#nutrition_tip6").click(toggleWhenClicked);
  $("#nutrition_tip7").click(toggleWhenClicked);
  $("#nutrition_tip8").click(toggleWhenClicked);
  $("#nutrition_tip9").click(toggleWhenClicked);
  $("#nutrition_tip10").click(toggleWhenClicked);
